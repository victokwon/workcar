$(function(){
    ...
    $(".pop-container").on('click', ".u",function(event) {
...
function getGrdDtl(target, act){
	 ...
	 $.ajax({
	    ...
	    success: function (res) {
	     	...
	     	drawGrdDtl(res.data ,target, act)
...
function drawGrdDtl(data, target, act){
	console.log(act)
	let html = ""
	...
	html += '			                <div class="star_content_box">                                                                                                  '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update-star" act="u" score="'+(data.WLB+ data.PROMO_POSS + data.C_CULT + data.WFARE_PAY + data.MGM)/5+'" >   </div>                      '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update_star" act="u"  score="'+data.WLB+'">  </div>                       '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update_star" act="u" score="'+data.PROMO_POSS+'">  </div>                       '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update_star" act="u" score="'+data.C_CULT+'">    </div>                     '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update_star" act="u" score="'+data.WFARE_PAY+'">   </div>                      '
		...
		html +=	'        <div class="body">                                      '
		if(act =="u"){
			html+= '	<div class="star_rating update_star" act="u" score="'+data.MGM+'"> </div>                       '
	...
	html += '			                        <div>한줄평가</div>                                                                                                           '
	html += '			                    </div>                                                                                                                        '
	html += '			                    <textarea name="eval" id="eval" cols="60" rows="2" spellcheck="false" placeholder="한줄평가" >'+data.EVAL+'</textarea>        '
	html += '		                    </div>                                                                                                                            '
