...
<link rel="stylesheet" type="text/css"
   href="resources\css\imemAttnd\corpAttnd\ca.css">
<link rel="stylesheet" type="text/css"
   href="resources\css\imemAttnd\corpAttnd\pop.css">
<link rel="stylesheet"
...
<script type="text/javascript"
	src="resources\script\imemAttnd\corpAttnd\caListNPrcss.js"></script>
<script type="text/javascript"
	src="resources\script\imemAttnd\corpAttnd\caPop.js"></script> 
...
<!-- 헤더 -->
	...
	<main>
		...
		<div class="main_button_box">
			...
			<button type="button" class="main_button" onclick="linkGo('corpAttnd')">활동내역</button>
		...
		<div class="main_info">
			<div id="main_inter" class="main_content">
				<div class="vertical_menu">
					<span onclick="linkGo('empAttnd')" ><a href="#" id="empAttnd">채용관심</a></span>
					<span onclick="linkGo('corpAttnd')" ><a href="#" id="corpAttnd">기업관심</a></span> 
				</div>
				
				<div class="main_box">
					<div class="inner_wrap">
						<table class="corpAttnd">
							<tr>
								<td>
