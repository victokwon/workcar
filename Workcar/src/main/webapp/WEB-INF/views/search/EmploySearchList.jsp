...
<link rel="stylesheet" type="text/css" href="resources/css/empsch/qualsch.css">
<link rel="stylesheet"
...
<body>
				...
				<div id="main_search" class="main_content">
					...
					<div class="main_section">
						<form action="#" id="actionForm2" method="post">
							<div>
								<span>공고일 / 마감일 :</span> <span>공고일</span> <input type="text"
									id="startDate" class="date_picker" /> <span>~</span> <span>마감일</span>
								<input type="text" id="endDate" class="date_picker" />
							</div>
							<div>
								<span>직종분류 :</span> <select name="fst_cate" id="fst_cate">
							...
							<div>
								<span>근무지역 :</span> <select name="bic_city" id="bic_city">
									<option value="city1">도/광역시</option>
								</select> <select name="city_fst" id="city_fst">
									<option value="city_fst1">시/군/구</option>
								</select> <select name="city_scd" id="city_scd">
									<option value="city_scd">시/군/구</option>
								</select> <select name="city_trd" id="city_trd">
							...
							<div class="sal">
								<span>급여(월급) :</span>
								<div class="input">
									<label for="sal0">내규</label> <input type="radio" name="sal"
										value="0" id="sal0"> <label for="sal1">일반</label> <input
										type="radio" name="sal" value="1" id="sal1"> <input
										type="text" placeholder="최저금액" id="minSal" disabled>만원
							...
							<div class="career">
								<span>경력 :</span>
								<div class="input">
									<label> 전체 <input type="radio" name="carr" id="career0"
										class="radiobox" value="0" /></label> <label> / 신입 <input
										type="radio" name="carr" id="career1" class="radiobox"
										value="1" /></label> <label> / 경력 <input type="radio"
										name="carr" id="career2" class="radiobox" value="2" /></label> <input
										type="text" class="input_box" placeholder="0" id="minCareer"
										disabled class="year_input"> 년 ~ <input type="text"
										class="input_box" placeholder="10" id="maxCareer" disabled
										class="year_input"> 년
								</div>
							</div>
							<div>
								<span>고용형태 :</span> <label> 정규직 <input type="radio"
									name="emp" class="radiobox" value="0" /></label> <label> / 계약직
									<input type="radio" name="emp" class="radiobox" value="1" />
								</label> <label> / 시간제 <input type="radio" name="emp"
									class="radiobox" value="2" /></label> <label> / 기타 <input
									type="radio" name="emp" class="radiobox" value="3" /></label>
							</div>
						</form>
					...
					<div id="more">
						<form action="#" id="actionForm3" method="post">
							<div>
								<span>최종학력 :</span> <label> 전체 <input type="radio"
									name="gradu" class="radiobox" value="0" /></label> <label> /
									고등학교 <input type="radio" name="gradu" class="radiobox"
									value="1" />
								</label> <label> / 전문대학 <input type="radio" name="gradu"
									class="radiobox" value="2" /></label> <label> / 대학교 <input
									type="radio" name="gradu" class="radiobox" value="3" /></label> <label>
									/ 석사 <input type="radio" name="gradu" class="radiobox"
									value="4" />
								</label> <label> / 박사 <input type="radio" name="gradu"
									class="radiobox" value="5" /></label>
							</div>
	...
	<script type="text/javascript" src="resources/script/empsch/DatePicker.js"></script>
