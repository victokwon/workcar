...
<link rel="stylesheet" type="text/css"
   href="resources\css\imemAct\subResum\subResum.css">
<link rel="stylesheet" type="text/css"
   href="resources\css\imemAct\subResum\pop.css">
<link rel="stylesheet"
...
<script type="text/javascript"
	src="resources\script\imemAct\subResum\SubResumListNPrcss.js"></script>
<script type="text/javascript"
	src="resources\script\imemAct\subResum\SubResumPop.js"></script> 
		...
		<div class="main_info">
			<div id="main_inter" class="main_content">
				...
				<div class="main_box">
					...
					<form action="#" id="subResumForm">
						<input type="hidden" id="goMemNo" name="memNo" value="${sMNo}">
						<input type="hidden" id="goResumNo" name="resumeNo" value="">
						<input type="hidden" id="page" name="page" value="${page }">
						<input type="hidden" id="actGbn" name="actGbn" value="Dtl">
					</form>
					<div id="subResum_paging_wrap"></div>
