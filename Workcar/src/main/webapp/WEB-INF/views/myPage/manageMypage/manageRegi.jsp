...
<title>Insert title here</title>
    ...
    <link rel="stylesheet" href="../../resources/css/Mypage/manageMypage/Mypage_regi_man.css">
    ...
    <script src="../../resources/script/Mypage/manageMypage/Mypage_regi_man.js"></script>
                        ...
                        <div class="main_box_texts">
                            <div>
                                <div class="main_box_text">
                                    <p class="main_box_txt1">아이디</p>
                                    <p class="main_box_txt2">이름</p>
                                    <p class="main_box_txt3">연락처</p>
                                    <p class="main_box_txt4">이메일 주소</p>
                                    <p class="main_box_txt5">이메일 수신 설정</p>
                                </div>
                            </div>
                            <form action="">
