      ...
      if($("#sal1").val() == "${DATA.PAY_GBN}"){
       ...
       // 자격증 1
        ...
        $("#addBtn3").on("click", function () {
          ...
          html += '<div class="detail">';
          html += " 재직기간";
          html += '<input type="text" name="carrStDate['+noBox.carrNo+']" id="stDate['+noBox.carrNo+']" placeholder="시작 년/월">~';
          html += '<input type="text" name="carrEndData['+noBox.carrNo+']" id="endData['+noBox.carrNo+']" placeholder="종료 년/월">';
          html += " 재직여부";
          html += '<input type="text" name="tureChk['+noBox.carrNo+']" id="tureChk['+noBox.carrNo+']">';
          html += " </div>";
          html += '<div class="detail">';
          html += " 직무내용";
          html +=
        ...
        $("#addBtn4").on("click", function () {
          ...
          html += '<div class="detail">';
          html += " 재학기간";
          html += '<input type="text" name="eduStDate['+noBox.eduNo+']" id="eduStDate['+noBox.eduNo+']" placeholder="시작 년/월">~';
          html += '<input type="text" name="eduEndData['+noBox.eduNo+']" id="eduEndDate['+noBox.eduNo+']" placeholder="종료 년/월">';
          html += " </div>";
          html += '<div class="detail">';
          html += " 특이사항";
          html +=
        ...
        $("#addBtn5").on("click", function () {
          ...
          html += '<div class="detail">';
          html += " 교육기간";
          html += '<input type="text" name="ieduStDate['+noBox.ieduNo+']" id="stDate['+noBox.ieduNo+']" placeholder="시작 년/월">~';
          html += '<input type="text" name="ieduEndData['+noBox.ieduNo+']" id="endData['+noBox.ieduNo+']" placeholder="종료 년/월">';
          html += " </div>";
          html += '<div class="detail">';
          html += " 교육내용";
          html +=
        ...
        $("#addBtn7").on("click", function () {
          ...
          html += '<div class="fileSNm" id="fileSNm[' +noBox.attchNo+ ']" name="attchName['+noBox.attchNo+']" id="attchName['+noBox.attchNo+']">파일명</div>';
                                    ...
                                    <label for="workType[${ workTypeCnt}]">${data.WORK_TYPE_NAME }</label>
                                       <c:choose>
                                          <c:when test="${!empty data.WORK_TYPE}">
                                             <input type="checkbox" name="workType[${ workTypeCnt}]" id="workType[${workTypeCnt }]" value="${ data.SCD_CAT}" checked="checked">
                                          </c:when>
                                          <c:otherwise>
                                             <input type="checkbox" name="workType[${ workTypeCnt}]" id="workType[${workTypeCnt }]" value="${ data.SCD_CAT}" >
                                          </c:otherwise>
                                       </c:choose>
                           ...
                           <div class="sal">
                              ...
                              <div class="input">
                                  <input type="radio" name="sal" value="0" id="sal0" >
                                            ...
                                            <input type="text" placeholder="최저금액" name="salMin" value="${DATA.PAY_MIN}" id="minSal" disabled>만원 ~
                                            <input type="text" placeholder="최대금액" name="salMax" value="${DATA.PAY_MAX}" id="maxSal" disabled>만원
                                        </div>
                           </div>
                        </div>
                     </div>
                              ...
                              <c:forEach var="data" items="${QUAL }">
                                 ...
                                 <input type="button" class="minus_btn" id="delBtn" value="－">
                                    <div class="data_container">
                                       <input type="text" name="qualNo[${ qualCnt}]" value="${data.QUAL_NAME }">
                                       <input type="text" name="issuAgcy[${qualCnt }]" value="${data.PASS_DATE }"> 
                                       <input type="text" name="passDate[${ qualCnt}]" value="${data.ISSU_AGCY }">
                                    </div>
                                 </div>
                        ...
                        <div class="con add_box flang">
                           ...
                           <c:set var="flangCnt" value="0"/>
                              <c:forEach var="data" items="${FLANG }">
                                 ...
                                 <input type="button" class="minus_btn" id="delBtn" value="－">
                                    <div class="data_container">
                                       <input type="text" name="flangNo[${ flangCnt}]" value="${data.FLANG_NAME }"> 
                                       <input type="text" name="flangType[${ flangCnt}]" value="${data.FLANG_TYPE }">
                                       <input type="text" name="flangGrade[${ flangCnt}]" value="${data.FLANG_GRADE }">
                                    </div>
                                 </div>
                           ...
                           <c:set var="carrCnt" value="0"/>
                              <c:forEach var="data" items="${CARR }">
                                 ...
                                 <input type="button" class="minus_btn r" id="delBtn" value="－">
                                    <div class="data_container ">
                                       <div class="detail">
                                          기업 <input type="text" name="cName[${ carrCnt}]"
                                             value="${data.C_NAME }">
                                       </div>
                                       <div class="detail">
                                          부서 <input type="text" name="dpart[${ carrCnt}]"
                                             value="${data.DPART }"> 직책 <input type="text" name="pos[${carrCnt }]"
                                              value="${data.POS }">
                                       </div>
                                       <div class="detail">
                                          재직기간 <input type="text" name="carrStDate[${ carrCnt}]"
                                             value="${data.ST_DATE }"> ~ <input type="text" name="carrEndData[${ carrCnt}]"
                                              value="${data.END_DATE }"> 재직여부
                                          <input type="text"  name="tureChk[${carrCnt }]"
                                             value="${data.TURE_CHK }">
                                       </div>
                                       <div class="detail">
                                          직무내용
                                          <textarea name="carrCntt[${carrCnt }]" spellcheck="false" >${data.CARR_CNTT }</textarea>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <c:set var="eduCnt" value="0"/>
                              <c:forEach var="data" items="${EDU }">
                                 ...
                                 <input type="button" class="minus_btn r" id="delBtn" value="－">
                                    <div class="data_container ">
                                       <div class="detail">
                                          학교 <input type="text" name="schName[${ eduCnt}]"
                                             value="${data.SCH_NAME }">
                                       </div>
                                       <div class="detail">
                                          학부 <input type="text" name="sol[${ eduCnt}]" 
                                             value="${data.SOL }"> 전공 <input type="text" name="major[${ eduCnt}]"
                                              value="${data.MAJOR }">
                                       </div>
                                       <div class="detail">
                                          재학기간 <input type="text"  name="eduStDate[${ eduCnt}]"
                                             value="${data.ST_DATE }">~ <input type="text" name="eduEndData[${ eduCnt}]"
                                              value="${data.END_DATE }">
                                       </div>
                                       <div class="detail">
                                          특이사항
                                          <textarea name="eduCntt[${ eduCnt}]" spellcheck="false" >${data.EDU_ETC }</textarea>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <c:set var="ieduCnt" value="0"/>
                              <c:forEach var="data" items="${IEDU }">
                                 ...
                                 <input type="button" class="minus_btn r" id="delBtn" value="－">
                                    <div class="data_container ">
                                       <div class="detail">
                                          기관 <input type="text" name="ieduName[${ ieduCnt}]"
                                             value="${data.IEDU_NAME }">
                                       </div>
                                       <div class="detail">
                                          훈련과정 <input type="text" name="coseName[${ ieduCnt}]"
                                             value="${data.COSE_NAME }">
                                       </div>
                                       <div class="detail">
                                          교육기간 <input type="text" name="ieduStDate[${ ieduCnt}]"
                                             value="${data.ST_DATE }">~ <input type="text" name="ieduEndDate[${ ieduCnt}]"
                                              value="${data.END_DATE }">
                                       </div>
                                       <div class="detail">
                                          교육내용
                                          <textarea name="ieduCntt[${ ieduCnt}]" spellcheck="false" >${data.CNTT }</textarea>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="con add_box">
                           ...
                           <c:set var="sintroCnt" value="0"/>
                              <c:forEach var="data" items="${SINTRO }">
                                 ...
                                 <input type="button" class="minus_btn r" id="delBtn" value="－">
                                    <input type="text" name="sintroName[${sintroCnt }]"
                                       value="${data.SINTRO_NAME }">
                                    <div class="data_container">
                                       <textarea name="sintroCntt[${sintroCnt }]" spellcheck="false" >${data.SINTRO_CNTT }</textarea>
                                    </div>
                                 </div>
